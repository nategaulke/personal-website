...
function ExperienceButton(props: any) {
  return (
    <div className="z-10 w-[80vw] overflow-hidden text-ellipsis rounded-lg border border-2 bg-white p-4 shadow duration-200 hover:shadow-none sm:flex lg:w-[40vw]">
      <div>
